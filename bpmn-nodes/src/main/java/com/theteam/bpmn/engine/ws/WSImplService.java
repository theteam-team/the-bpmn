 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://ws.engine.bpmn.theteam.com/", wsdlLocation = "file:/C:/work/the-bpmn/soap_server/src/main/resources/wsdl/ws.xml")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://ws.engine.bpmn.theteam.com/", "WSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/work/the-bpmn/soap_server/src/main/resources/wsdl/ws.xml");
    ...
    public WS getWSImplPort() {
        return super.getPort(new QName("http://ws.engine.bpmn.theteam.com/", "WSImplPort"), WS.class);
    }
    ...
    public WS getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.engine.bpmn.theteam.com/", "WSImplPort"), WS.class, features);
    }
